...
> Personal Health Manager — 个人健身健康管理应用 v1.9.1
...
| 模块 | 功能 |
|------|------|
| 🏋️ 训练 | 力量（记录/计划/断签/周统计）+ 有氧（记录/计划/统计）子 Tab，顶部「今日速览」概览本周与本旬进度，**常用动作按频次排序**；容量 ≥100kg 解锁 🔮 隐藏挑战召唤 |
| 📊 个人 | 基本信息、体重记录与趋势图、PR 个人最佳、训练统计、30 天每日趋势、热力图 |
| 🎮 挑战 | 15 章 90 关 RPG 战斗、关卡预览与胜率模拟、**旬目标进度条 + 结算预告**、战利品掉落、炼魂系统（9 级品质）、属性变更日志、历史最佳、分享卡片、首次规则引导、**隐藏挑战小游戏（8-12s 倒计时点击攻击，伤害兑月奖励）** |
