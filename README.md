...
> Personal Health Manager — 个人健身健康管理应用 v1.9.2
...
| 模块 | 功能 |
|------|------|
| 🏋️ 训练 | 力量（记录/计划/断签/周统计）+ 有氧（记录/计划/统计）子 Tab，顶部「今日速览」概览本周与本旬进度，**常用动作按频次排序，记录显示等效容量与倍率**；容量每 100kg 叠加 🔮 隐藏挑战召唤次数与几率 |
...
| **v1.9.2** | **2026-08-14** | **召唤改版（每100kg叠加次数与几率）+ 预览确认界面 + 热血buff（周连续4天解锁：暴击率+40%·暴伤+20% / 暴伤+200%·暴击率+15% / 倒计时+80%·基础时间80~100%）+ 训练记录等效容量与倍率** | `doc/changelog-v1.9.md` |
