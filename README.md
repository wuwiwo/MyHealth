...
> Personal Health Manager — 个人健身健康管理应用 v2.1.6
...
| 🎮 挑战 | 三视图（🐾 培养 / ⚔️ 战斗 / 📊 记录）。**单敌线**：21 章 117 关（16 章起 BOSS 双词条）、关卡预览与胜率模拟、炼魂系统（9 级品质）、属性变更日志、历史最佳、分享卡片。**敌群线**：9 大关 × 10 小关 = 90 关多对多战斗（16 天赋 / 25 技能 / 12 状态 / 6 场地 / AI 策略 + **命中闪避系统**）、**宠物养成**（14 只 / 蛋→成熟 / 炼化 / 6 种材料 / 最多 2 只参战 / 专属天赋）、**玩家技能**（9 技能 / 技能点 / 装备槽）。另含**隐藏挑战小游戏**（预览确认后 8-12s 倒计时点击，伤害兑月奖励，周 4 天连续解锁热血 buff）与旬目标进度条 + 结算预告 |
...
> 当前版本：**v2.1.6**（设计规范：`doc/design-tokens-v2.1.md`）
